                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'Search for category or product ...',
                      ...
                      itemBuilder: (context, listViewIndex) {
                        ...
                        return Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'CATEGORY_Container_d6caoh78_ON_TAP');
                              logFirebaseEvent('Container_update_app_state');
                              setState(() {
                                FFAppState().selectedCategory =
                                    listViewCategoryRecord.id;
                              });
                            },
                            child: Container(
                              width: 100.0,
              ...
              Padding(
                ...
                child: StreamBuilder<List<ItemCategoryRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<ItemCategoryRecord> listViewItemCategoryRecordList =
                        snapshot.data!;
                    return ListView.builder(
                      padding: EdgeInsets.zero,
                      primary: false,
                              ...
                              child: Row(
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: Image.network(
                                      listViewItemCategoryRecord.imageUrl,
                                      width: 36.0,
                                      height: 36.0,
                                      fit: BoxFit.cover,
                                    ),
